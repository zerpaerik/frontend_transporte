...
export default function NotaCreditoPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <button onClick={() => router.push("/facturacion")} className="mb-4 inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 hover:text-brand-600"><ArrowLeft size={16} /> Volver a facturación</button>
